...
const itinerary = [
  ...
  { city: 'Denver, CO', coords: [39.7392, -104.9903], arrival: '2025-06-27', departure: '2025-06-29', nights: 2 },
  { city: 'Lincoln, NE', coords: [40.8136, -96.7026], arrival: '2025-06-29', departure: '2025-06-29', nights: 0 },
  { city: 'Chicago, IL', coords: [41.8781, -87.6298], arrival: '2025-06-30', departure: '2025-06-30', nights: 0 },
  { city: 'New York, NY', coords: [40.7128, -74.0060], arrival: '2025-06-30', departure: '2025-07-02', nights: 2 },
  { city: 'Washington, DC', coords: [38.9072, -77.0369], arrival: '2025-07-02', departure: '2025-07-07', nights: 5 },
  { city: 'Raleigh, NC', coords: [35.7796, -78.6382], arrival: '2025-07-07', departure: '2025-07-10', nights: 3 },
  { city: 'Atlanta, GA', coords: [33.7490, -84.3880], arrival: '2025-07-10', departure: '2025-07-11', nights: 1 },
  { city: 'Fort Worth, TX', coords: [32.7555, -97.3308], arrival: '2025-07-11', departure: '2025-07-11', nights: 0 },
  { city: 'Oklahoma City, OK', coords: [35.4676, -97.5164], arrival: '2025-07-12', departure: '2025-07-12', nights: 0 },
  { city: 'Los Angeles, CA', coords: [34.0522, -118.2437], arrival: '2025-07-13', departure: '2025-07-14', nights: 1 },
  { city: 'Oakland, CA', coords: [37.8044, -122.2711], arrival: '2025-07-15', departure: '2025-07-15', nights: 0 },
];

const segments = [
  { name: 'California Zephyr (OAK→DEN)',    from: 'Oakland, CA',         to: 'Denver, CO',         date: 'Jun 26', depart: '7:15 AM',  arrive: '6:38 AM (Jun 27)' },
  { name: 'California Zephyr (DEN→LIN)',    from: 'Denver, CO',          to: 'Lincoln, NE',        date: 'Jun 29', depart: '7:00 AM',  arrive: '1:30 PM (Jun 29)' },
  { name: 'California Zephyr (LIN→CHI)',    from: 'Lincoln, NE',         to: 'Chicago, IL',        date: 'Jun 30', depart: '6:00 AM',  arrive: '2:50 PM (Jun 30)' },
  { name: 'Lake Shore Limited',             from: 'Chicago, IL',         to: 'New York, NY',       date: 'Jun 30', depart: '3:55 PM',  arrive: '6:30 PM (Jul 1)' },
  { name: 'Regional',                       from: 'New York, NY',        to: 'Washington, DC',     date: 'Jul 2',  depart: '10:00 AM', arrive: '1:10 PM (Jul 2)' },
  { name: 'Carolinian',                     from: 'Washington, DC',      to: 'Raleigh, NC',        date: 'Jul 7',  depart: '3:08 PM',  arrive: '9:37 PM (Jul 7)' },
  { name: 'Crescent',                       from: 'Raleigh, NC',         to: 'Atlanta, GA',        date: 'Jul 10', depart: '6:30 AM',  arrive: '4:00 PM (Jul 10)' },
  { name: 'Texas Eagle',                    from: 'Atlanta, GA',         to: 'Fort Worth, TX',     date: 'Jul 11', depart: '10:00 AM', arrive: '10:00 PM (Jul 11)' },
  { name: 'Heartland Flyer',                from: 'Fort Worth, TX',      to: 'Oklahoma City, OK',  date: 'Jul 12', depart: '8:25 AM',  arrive: '12:21 PM (Jul 12)' },
  { name: 'Southwest Chief',                from: 'Oklahoma City, OK',   to: 'Los Angeles, CA',    date: 'Jul 13', depart: '6:00 AM',  arrive: '8:00 PM (Jul 13)' },
  { name: 'Coast Starlight',                from: 'Los Angeles, CA',     to: 'Oakland, CA',        date: 'Jul 14', depart: '10:10 AM', arrive: '9:32 PM (Jul 15)' },
];
